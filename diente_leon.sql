...
For each row 
Insert into tabla_cliente(idCliente,nombre_cliente,telefono_cliente,correo_cliente) values(NEW.idCliente,NEW.nombre_cliente,NEW.telefono_cliente,NEW.correo_cliente);

Create trigger trg_insert_empleado
After insert on empleado
For each row 
Insert into tabla_empleado(idEmpleado,nombre_empleado,telefono_empleado) values(NEW.idEmpleado,NEW.nombre_empleado,NEW.telefono_empleado)
